...
public class ExpressList<T extends ExpressGeneralizedDataType> extends ExpressAggregation<T> {
	...
	public ExpressList(Integer id,Integer bound1, Integer bound2,T dataType) {
		super(id);
		setBound1(bound1);
		setBound2(bound2);
